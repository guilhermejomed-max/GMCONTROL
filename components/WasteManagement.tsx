...
export const WasteManagement: React.FC<WasteManagementProps> = ({ orgId, partners, collaborators }) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">Gerencie e registre o descarte ambiental da oficina.</p>
        </div>
        <button
                ...
                <tr key={disposal.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
                      ...
                      <span className="text-sm font-bold">{disposal.partnerName}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
                      <User className="h-4 w-4 opacity-50" />
                      <span className="text-sm font-medium">{disposal.responsibleName}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex flex-col gap-1">
